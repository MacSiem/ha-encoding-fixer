...
Fix UTF-8 / mojibake encoding issues across HA configs and entities.
...
2. Repository URL: `https://github.com/MacSiem/ha-encoding-fixer` — Category: **Lovelace**
3. Install **Encoding Fixer** from HACS
...
```yaml
panel_custom:
  - name: ha-encoding-fixer
    sidebar_title: Encoding Fixer
    sidebar_icon: mdi:home-assistant
    url_path: ha-encoding-fixer
    js_url: /local/community/ha-encoding-fixer/ha-encoding-fixer.js
    embed_iframe: false
    config: {}
```

After restart, **Encoding Fixer** appears in the HA sidebar.
